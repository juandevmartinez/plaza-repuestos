...
<tr class="shipping shipping-row <?php echo ( ! empty( $class ) ) ? esc_attr( $class ) : ''; ?>" data-order_item_id="<?php echo esc_attr( $item_id ); ?>">
    <td>
        <div class="order-item-img icon-item">
            <i class="wcmp-font ico-shippingnew-icon"></i>
        </div>
    </td>
    <td colspan="3">
        <div class="order-item-detail">
            ...
            <table>
                <?php do_action( 'wcmp_vendor_dash_before_order_itemmeta', $item_id, $item, null ); ?>
		<?php require 'html-order-item-meta.php'; ?>
		<?php do_action( 'wcmp_vendor_dash_after_order_itemmeta', $item_id, $item, null ); ?>
            </table>
        </div>        
    </td>
    <td>
