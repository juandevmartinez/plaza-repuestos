...
<div class="wc-metabox closed">
        <div class="panel-heading d-flex">
			...
			printf( _n( 'Downloaded %s time', 'Downloaded %s times', $download->get_download_count(), 'dc-woocommerce-multi-vendor' ), esc_html( $download->get_download_count() ) )
			?>
                    </strong>
                </a>
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="download-remaining-wrap col-md-4 col-sm-4">
                        <label><?php esc_html_e( 'Downloads remaining', 'dc-woocommerce-multi-vendor' ); ?></label>
                    ...
                    <div class="access-expire-wrap col-md-4 col-sm-4">
                        <label><?php esc_html_e( 'Access expires', 'dc-woocommerce-multi-vendor' ); ?></label>
                    ...
                    <div class="copy-link-wrap col-md-4 col-sm-4">
                        <label><?php esc_html_e( 'Customer download link', 'dc-woocommerce-multi-vendor' ); ?></label>
                        <?php
