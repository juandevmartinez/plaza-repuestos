...
class WCMp_Gateway_RazorPay extends WCMp_Payment_Gateway {
    ...
    public function validate_request() {
        ...
        if ($this->enabled != 'Enable') {
            ...
            $this->message[] = array('message' => __('Razorpay payout setting is not configured properly. Please contact site administrator', 'dc-woocommerce-multi-vendor'), 'type' => 'error');
            return false;
        } else if (!$this->reciver_email) {
            $this->message[] = array('message' => __('Please update your Razorpay Account information to receive commission', 'dc-woocommerce-multi-vendor'), 'type' => 'error');
            return false;
        }
