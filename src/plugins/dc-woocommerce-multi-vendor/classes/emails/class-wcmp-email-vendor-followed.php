...
class WC_Email_Vendor_Followed extends WC_Email {
    ...
    public function get_default_subject() {
        return apply_filters('wcmp_vendor_followed_email_subject', __('Vendor Followed Email', 'dc-woocommerce-multi-vendor'), $this->object);
    }
    ...
    public function get_default_heading() {
        return apply_filters('wcmp_vendor_new_order_email_heading', __('Vendor Followed', 'dc-woocommerce-multi-vendor'), $this->object);
    }
