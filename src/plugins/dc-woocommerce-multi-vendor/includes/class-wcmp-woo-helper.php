...
final class WCMp_Woo_Helper {
     ...
     * Main WCMp Instance.
     *
     * Ensures only one instance of WCMp is loaded or can be loaded.
     *
     * @since 3.2.3
     * @static
     * @see WCMp
     *
     * @return object The WCMp object.
     */
...
if ( ! function_exists( 'wcmp_woo' ) ) {

    function wcmp_woo() {
        return WCMp_Woo_Helper::instance();
    }
