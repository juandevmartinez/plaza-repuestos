...
class TZ_Banner extends Widget_Base
{
	...
	protected function _register_controls() {
		...
		$this->add_control(
		  'main_caption_pos',
		  [
			    'label' => esc_html__( 'Specify top/left offset for banner main caption', 'tz-feature-pack' ),
        ...
        $this->add_control(
            'banner_button',
            [
                'label' => esc_html__( 'Banner Button', 'tz-feature-pack' ),
        ...
        $this->add_control(
            'banner_button_pos',
            [
                'label' => __( 'Specify top/left offset for banner button', 'tz-feature-pack' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'allowed_dimensions' => array('top','left'),
                'selectors' => [
                    '{{WRAPPER}} .banner-button' => 'top: {{TOP}}{{UNIT}}; left: {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'banner_button_style',
            [
                'label' => esc_html__('Banner Button Style', 'tz-feature-pack'),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__('Default', 'tz-feature-pack'),
                    'light' => esc_html__('Light', 'tz-feature-pack'),
                ],
            ]
        );
		$this->add_control(
	...
	protected function render() {
		...
		$output .= '<figure class="tz-banner effect-'. esc_attr( $settings['hover_effect'] ) .' tz-banner-button-style-'.esc_attr( $settings['banner_button_style']).' ">';
        ...
        if ( $settings['banner_button'] && $settings['banner_button'] != '' ) {
            $output .= '<a class="banner-button">' . $settings['banner_button'] . '</a>';
        }
		$output .= '</figcaption>';
