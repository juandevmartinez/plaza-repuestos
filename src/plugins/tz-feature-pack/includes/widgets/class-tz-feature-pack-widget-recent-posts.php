...
class tz_recent_posts extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'tz_recent_posts',
			esc_html__('TZ Recent Posts', 'tz-feature-pack'),
			array('description' => esc_html__( "Themes Zone special widget. Displaying number of recent posts on your site.", 'tz-feature-pack' ), )
		);
	}
