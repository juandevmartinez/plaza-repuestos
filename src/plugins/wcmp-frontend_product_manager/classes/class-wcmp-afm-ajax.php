    ...
    public function appointment_list() {
        ...
        if ( $vendor_appointments ) {
            foreach ( $vendor_appointments as $vendor_appointment ) {
                ...
                $row['appointment'] = '';
                $row['appointment'] .= sprintf( '<a href="%s">' . __( $buyer, 'woocommerce-appointments' ) . '</a>', esc_url( wcmp_get_vendor_dashboard_endpoint_url( 'appoints', $vendor_appointment->ID ) ) ) .'-'. $appointment->get_status() .'<br>';
                ...
                $row['actions'] = sprintf( '<a href="%s">' . __( 'View', 'woocommerce-bookings' ) . '</a>', esc_url( wcmp_get_vendor_dashboard_endpoint_url( 'appoints', $vendor_appointment->ID ) ) );
    ...
    public function auction_list() {
        ...
        if ( $vendor_auctions ) {
            foreach ( $vendor_auctions as $auction_product ) {
                ...
                $dateinic = $auction_product->get_start_date();
                if ( $dateinic ) {
                ...
                $dateclose = $auction_product->get_end_date();
                if ( $dateclose ) {
