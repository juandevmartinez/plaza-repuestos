    ...
    function wp_affiliate_capabilities( $data ){
      $data['sections']['affiliate_area'] = array( "title"  => __( 'Affiliate', 'wcmp-afm' ), // Section one
        "fields" => apply_filters( "wcmp_vendor_affiliate_capability_options", array(
            "affiliate_cap_vendor"      => array( 'title' => __( 'Disable Request Affiliate', 'wcmp-afm' ), 'type' => 'checkbox', 'id' => 'affiliate_cap_vendor', 'label_for' => 'affiliate_cap_vendor', 'name' => 'affiliate_cap_vendor', 'value' => 'Enable' ), // Checkbox
            )
        )
      );
      return $data;
