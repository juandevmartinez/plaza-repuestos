...
( function ( $ ) {
    var auctionsTable = $( '#auctions_table' ).DataTable( {
        ...
        ajax: {
            ...
            data: function ( data ) {
                data.action = 'wcmp_vendor_simple_auction_list';
        ...
        columns: [
            ...
            { data: "start-date", orderable: false },
            { data: "end-date", orderable: false },
            { data: "auction-status", orderable: false },
            { data: "max-bid", orderable: false },
        ]
    } );
