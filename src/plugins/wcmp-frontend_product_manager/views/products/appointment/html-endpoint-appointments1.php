...
<div class="col-md-12">
    <div class="panel panel-default panel-pading mt-0">
        ...
        foreach ( $statuses as $key => $label ) {
            ...
            if ( $count_pros ) {
                echo '<li><a href="' . add_query_arg( array( 'post_status' => sanitize_title( $key ) ), wcmp_get_vendor_dashboard_endpoint_url( 'appoints' ) ) . '" class="' . ( $current_status == $key ? 'current' : '' ) . '">' . $label . ' ( ' . $count_pros . ' ) </a></li>';
            }
        }
        echo '</ul><br/>';
        ?>
