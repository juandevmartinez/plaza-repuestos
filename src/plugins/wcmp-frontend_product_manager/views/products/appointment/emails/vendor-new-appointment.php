...
echo make_clickable( sprintf( esc_html__( 'You can view and edit this appointment in the dashboard here: %s', 'woocommerce-appointments' ), esc_url( wcmp_get_vendor_dashboard_endpoint_url( 'appoints', $appointment->get_id() ) ) ) ); // WPCS: XSS ok.
?>
</p>
