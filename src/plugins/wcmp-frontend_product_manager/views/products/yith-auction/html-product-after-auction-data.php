...
<div class = "form-group-row">
    <div class = "form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_decimal" id="_yith_check_time_for_overtime_option" name="_yith_check_time_for_overtime_option" value="<?php echo ($auctionable_product) ? $auctionable_product->get_check_time_for_overtime_option('edit') : ''; ?>" step="any" min="0">
        </div>
    </div> 
</div>
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_decimal" id="_yith_overtime_option" name="_yith_overtime_option" value="<?php echo ($auctionable_product) ? $auctionable_product->get_overtime_option('edit') : ''; ?>" step="any" min="0">
        </div>
    </div> 
</div>
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_decimal" id="_yith_wcact_auction_automatic_reschedule" name="_yith_wcact_auction_automatic_reschedule" value="<?php echo ($auctionable_product) ? $auctionable_product->get_automatic_reschedule('edit') : ''; ?>" step="any" min="0">
        </div>
    </div> 
</div>
<?php
$reschedule_auction_unit = ($auctionable_product) ? $auctionable_product->get_automatic_reschedule_auction_unit('edit') : '';
?>
<div class="form-group-row"> 
    <div class="form-group">
...
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="checkbox" class="form-control" id="_yith_wcact_show_upbid" name="_yith_wcact_show_upbid" value="yes" <?php checked( $auctionable_product->get_upbid_checkbox('edit'), 'yes' ); ?>>
...
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="checkbox" class="form-control" id="_yith_wcact_show_overtime" name="_yith_wcact_show_overtime" value="yes" <?php checked( $auctionable_product->get_overtime_checkbox('edit'), 'yes' ); ?>>
