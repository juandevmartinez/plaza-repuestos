...
?></label>
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_price" id="_yith_auction_start_price" name="_yith_auction_start_price" value="<?php echo ($auctionable_product) ? $auctionable_product->get_start_price('edit') : ''; ?>" step="any" min="0">
        </div>
    </div> 
</div>
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_price" id="_yith_auction_bid_increment" name="_yith_auction_bid_increment" value="<?php echo ($auctionable_product) ? $auctionable_product->get_bid_increment('edit') : ''; ?>" step="any" min="0">
        </div>
    </div> 
</div>
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_price" id="_yith_auction_minimum_increment_amount" name="_yith_auction_minimum_increment_amount" value="<?php echo ($auctionable_product) ? $auctionable_product->get_minimum_increment_amount('edit') : ''; ?>" step="any" min="0"> 
        </div>
    </div> 
</div>
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_price" id="_yith_auction_reserve_price" name="_yith_auction_reserve_price" value="<?php echo ($auctionable_product) ? $auctionable_product->get_reserve_price('edit') : ''; ?>" step="any" min="0">
        </div>
    </div> 
</div>
<div class="form-group-row"> 
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-9">
            <input type="number" class="form-control wc_input_price" id="_yith_auction_buy_now" name="_yith_auction_buy_now" value="<?php echo ($auctionable_product) ? $auctionable_product->get_buy_now('edit') : ''; ?>" step="any" min="0">
        </div>
    </div> 
</div>