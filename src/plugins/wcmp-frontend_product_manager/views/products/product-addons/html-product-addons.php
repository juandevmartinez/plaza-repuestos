...
$addon_type_formatted            = ! empty( $addon_type ) ? WCMp_AFM_Product_Addons_Integration::convert_type_name( $addon_type ) : __( 'Multiple choice', 'woocommerce-product-addons' );
...
?>
<div class="wcmp-metabox-wrapper woocommerce_product_addon wc-metabox wc-pao-addon closed" rel="<?php echo esc_attr( $loop ); ?>">
    <div class="wcmp-metabox-content wc-pao-addon-header" id="product_addon_<?php esc_attr_e( $loop ); ?>">
    ...
    <div class="wc-pao-addon-content">
        ...
        <?php do_action( 'wcmp_product_addons_panel_before_options', $post, $addon, $loop ); ?>
                ...
                <div class="wc-pao-addon-content-headers">
                    ...
                    <div class="wc-pao-addon-content-price-header">
                        <div class="wc-pao-addon-content-price-wrap">
                            ...
                            <span class="img_tip" data-desc="<?php esc_html_e( 'Choose how to calculate price: apply a flat fee regardless of quantity, charge per quantity ordered, or charge a percentage of the total', 'woocommerce-product-addons', 'woocommerce' ); ?>"></span>
                    ...
                    <?php do_action( 'wcmp_product_addons_panel_option_heading', isset( $post ) ? $post : null, $addon, $loop ); ?>
                </div>
        ...
        <div class="wc-pao-addon-content-non-option-rows <?php echo esc_attr( $display_non_option_rows_class ); ?>">
            ...
            <div class="wc-pao-row wc-pao-addon-adjust-price-container <?php echo esc_attr( $display_adjust_price ); ?>">
                ...
                <div class="wc-pao-addon-adjust-price-settings <?php echo esc_attr( $display_adjust_price_settings ); ?>">
                    ...
                    <?php do_action( 'wcmp_product_addons_after_adjust_price', $addon, $loop ); ?>
                </div>
            </div>
        </div>
    </div>
