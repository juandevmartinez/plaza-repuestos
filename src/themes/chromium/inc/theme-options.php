...
if (class_exists('Chromium_Kirki')) {
    ...
    Chromium_Kirki::add_section( 'chromium-general', array(
        'title'       => esc_html__( 'General Options', 'chromium' ),
        'description' => 'Global Theme Options',
    ...
    Chromium_Kirki::add_field( 'chromium', array(
        ...
        'label'       => esc_html__( 'General Style', 'chromium' ),
        'section'     => 'chromium-general',
        'default'     => 'parts',
        'choices'     => array(
            'parts' => esc_html__( 'Auto Parts Shop Style', 'chromium' ),
            'tools' => esc_html__( 'Tools Shop Style', 'chromium' ),
            'tires' => esc_html__( 'Tires Shop Style', 'chromium' ),
        ),
    ) );
	...
	'default'     => 'col-3',
	'choices'     => array(
            'col-2' => esc_html__( '2 Cols', 'chromium' ),
	...
	Chromium_Kirki::add_field( 'chromium', [
        'type'     => 'textarea',
        'settings' => 'header_custom_area',
        'label'    => esc_html__( 'Header Home Page Static Hero Text', 'chromium' ),
        'section'  => 'chromium-header',
        'default'  => '',
        'priority' => 10,
    ] );
    ...
    Chromium_Kirki::add_field( 'chromium', array(
        ...
        'label'       => esc_html__( 'Elementor Header', 'chromium' ),
        'description' => esc_attr__( 'Enable or disable Elementor template to show instead of default WordPress header', 'chromium' ),
        'section'     => 'chromium-header',
        'default'     => false,
        'priority'    => 11,
        'choices'     => array(
            'enabled'  => esc_attr__( 'Enabled', 'chromium' ),
            'disabled'   => esc_attr__( 'Disables', 'chromium' ),
        ),
    ) );
    ...
    Chromium_Kirki::add_field( 'chromium', array(
        ...
        'label'       => esc_html__( 'Set different header for home page', 'chromium' ),
        'description' => esc_attr__( 'Enable if you wish to set a custom header for home page.', 'chromium' ),
        'section'     => 'chromium-header',
        'default'     => false,
        'priority'    => 12,
        'choices'     => array(
            'enabled'  => esc_attr__( 'Enabled', 'chromium' ),
            'disabled'   => esc_attr__( 'Disabled', 'chromium' ),
        ),
        'active_callback' => array(
            array(
...
if (class_exists('WooCommerce')) {
    ...
    'default'     => array(
		...
		'output'      => array(
			  ...
			  array(
				...
				array(
			    'choice'   => 'secondary',
			    'element'  => array('.quantity .quantity-button:before',
			  ...
			  array(
			    ...
			    'element'  => array(
			        '.ui-slider-horizontal .ui-slider-range',
                                                            ...
                                                            'figure.effect-sarah',
                                                            'body:not(.chromium-look-tires) .widget_tz_shopping_cart .heading .cart-count-wrapper',
	...
	Chromium_Kirki::add_field( 'chromium', array(
		...
		'output'      => array(
				...
				array(
					...
					'element'  => array('.site-sidebar a:hover','.site-sidebar a:focus','.site-sidebar a:active', '.site-sidebar .current-cat a',
				...
				array(
					...
					'element'  => array('.header-top a', ' .elementor-header-top a'),
					'property' => 'color',
				),
				array(
	...
	Chromium_Kirki::add_field( 'chromium', array(
		...
		'output'      => array(
				array(
					'choice'   => 'border',
					'element'  => array('.primary-nav','.widget .widget-title','.elementor-widget h5',
                                                            ...
                                                            '.tz-login-form-wrapper','.tz-login-form-wrapper .heading',
		...
		'output'      => array(
				...
				array(
					...
					'element'  => array('button:hover','html input[type="button"]:hover','input[type="reset"]:hover','input[type="submit"]:hover','.button:hover',
															...
															'.primary-nav .current-menu-item a','.logo-group-nav .current-menu-item a','.primary-nav .menu > li > a:hover',
                                                            '.primary-nav .nav-menu > li > a:hover',
															'.logo-group-nav .menu > li > a:hover',
                                                            '.primary-nav .menu > li > a:focus',
                                                            '.logo-group-nav .menu > li > a:focus',
															'.primary-nav > li > .menu a:active',
                                                            '.logo-group-nav .menu > li > a:active'),
					'property' => 'color',
				),
				array(
					'choice'   => 'background-color',
				...
				array(
					...
					'element'  => array('button:hover','html input[type="button"]:hover','input[type="reset"]:hover','input[type="submit"]:hover','.button:hover',
                                                            ...
                                                            '.logo-group-nav .current-menu-item a',
                                                            '.primary-nav .menu > li > a:hover',
                                                            '.primary-nav .nav-menu > li > a:hover',
															'.logo-group-nav .menu > li > a:hover',
                                                            '.logo-group-nav .nav-menu > li > a:hover',
                                                            '.primary-nav .menu > li > a:focus',
		...
		'output'      => array(
				...
				array(
					...
					'element'  => array('.primary-alt-btn button:hover','html .primary-alt-btn input[type="button"]:hover',
                        ...
                        'figure.tz-banner .banner-button:hover',
                        'figure.tz-banner .banner-button:active'
                        ),
					'property' => 'color',
				),
				array(
